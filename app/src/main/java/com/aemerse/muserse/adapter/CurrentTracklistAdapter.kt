...
class CurrentTracklistAdapter constructor(context: Context, dragStartListener: OnStartDragListener) : RecyclerView.Adapter<CurrentTracklistAdapter.MyViewHolder?>(), ItemTouchHelperAdapter,
