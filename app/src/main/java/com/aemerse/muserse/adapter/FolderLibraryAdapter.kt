...
import com.aemerse.muserse.activity.ActivityMain
...
class FolderLibraryAdapter constructor(private val context: Context) :
    ...
    private fun excludeFolder() {
        ApplicationClass.getPref().edit()
            .putString(ApplicationClass.getContext().getString(R.string.pref_excluded_folders),
                ApplicationClass.getPref().getString(ApplicationClass.getContext().getString(R.string.pref_excluded_folders),
