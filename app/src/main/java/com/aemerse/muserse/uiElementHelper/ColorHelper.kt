...
object ColorHelper {
    fun getPrimaryColor(): Int {
        ...
        return ApplicationClass.getPref().getInt(ApplicationClass.getContext().resources
    ...
    fun getBaseThemeDrawable(): Drawable {
        var d: Drawable = ColorDrawable(ApplicationClass.getContext().resources
            .getColor(R.color.light_gray2))
        val pref: Int =
            ApplicationClass.getPref().getInt(ApplicationClass.getContext().resources
        ...
        when (pref) {
            ...
            Constants.PRIMARY_COLOR.DARK -> d = ColorDrawable(
                ApplicationClass.getContext().resources.getColor(R.color.dark_gray2))
    ...
    fun getColor(id: Int): Int {
        return ApplicationClass.getContext().resources.getColor(id)
    }

    fun getBaseThemeTextColor(): Int {
        var color: Int = ApplicationClass.getContext().resources.getColor(R.color.light_text)
        val pref: Int =
            ApplicationClass.getPref().getInt(ApplicationClass.getContext().resources
                .getString(R.string.pref_theme), Constants.PRIMARY_COLOR.LIGHT)
        when (pref) {
            Constants.PRIMARY_COLOR.LIGHT -> {}
            Constants.PRIMARY_COLOR.DARK -> color = ApplicationClass.getContext()
                .resources.getColor(R.color.dark_text)
            Constants.PRIMARY_COLOR.GLOSSY -> color = ApplicationClass.getContext()
                .resources.getColor(R.color.dark_text)
        }
        return color
    ...
    fun getGradientDrawable(): Drawable {
        return getGradientDrawable(ApplicationClass.Companion.getSelectedThemeId())
    }
